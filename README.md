...
From completing this project I was able to understand how REST API works as well as learning that REST API is scalable, felixible and also caching is easier since the server is stateless and each request can be processed individually. </br>
